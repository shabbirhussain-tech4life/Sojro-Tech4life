...
public class MainSupportServiceActivity extends FragmentsHandlerActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setNavClickListener();
        replaceFragment(MainRadiologyFragment.newInstance());


    }

    public static void start(Context context) {
        Intent starter = new Intent(context, MainSupportServiceActivity.class);
    ...
    public void signOut() {
        ...
        AppPref.getInstance(this).remove(AppPref.Key.USER_LOGIN, AppPref.Key.IS_RADIOLOGY_LOGIN,AppPref.Key.KEY_RECORD_ID);
