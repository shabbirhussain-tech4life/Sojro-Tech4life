...
public class RadiologyImgeUpload extends ImageUploadFragment {
    ...
    public static RadiologyImgeUpload newInstance(String id,String recordid) {
        RadiologyImgeUpload fragment = new RadiologyImgeUpload();
        mId = id;
        record_id = recordid;
        return fragment;
    }
    ...
    public void onValidation() {
        ...
        if(images_path != null && !images_path.isEmpty()) {
            for (int i = 0; i < images_path.size(); i++) {
                ...
                if (file.exists()) {
                    ...
                    try {
                        new MultipartUploadRequest(this.getContext(), uploadId, AppModule.UPLOAD_URL1)
        ...
        apiFactory.radiology_image(mId, parts,record_id)
