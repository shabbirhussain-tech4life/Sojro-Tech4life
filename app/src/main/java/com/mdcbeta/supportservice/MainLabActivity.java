...
public class MainLabActivity extends FragmentsHandlerActivity {
    ...
    VectorDrawableTextView txtname;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtname.setText("laboratory");
        setUpDrawer();
        setActionBarListener();
        setNavClickListener();
        replaceFragment(MainLaboratoryFragment.newInstance());


    }

    public static void start(Context context) {
        Intent starter = new Intent(context, MainLabActivity.class);
