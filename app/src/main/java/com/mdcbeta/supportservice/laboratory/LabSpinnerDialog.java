...
public class LabSpinnerDialog extends BaseDialogFragment {
    ...
    public static LabSpinnerDialog newInstance(String id) {
        LabSpinnerDialog frag = new LabSpinnerDialog();
        mId = id;
        return frag;
    }
    ...
    public void onValidationSucceeded() {
        ...
        apiFactory.updateLabStatus(mId,
                relation)
