...
import com.mdcbeta.supportservice.Adapter.PharmacyAdapter;
...
public class MainPrescriptionFragment extends BaseFragment implements BaseDialogFragment.DialogClickListener {
    ...
    public MainPrescriptionFragment() {
        // Required empty public constructor
    }

    public static MainPrescriptionFragment newInstance() {
        MainPrescriptionFragment fragment = new MainPrescriptionFragment();
        return fragment;
    }
    ...
    public void getCasesForReffer(){
        ...
        apiFactory.pharmacy_cases(getUser().getId())
    ...
    private void initList() {
        ...
        adapter.setSpinnerClickListner(object-> {
            ...
            if (object.get("status").getAsString().equals("Completed"))
            {
                ...
                getFragmentHandlingActivity().addDialog(this, PharmacySpinnerDialog.newInstance(object.get("id").getAsString()));
            }
        });
