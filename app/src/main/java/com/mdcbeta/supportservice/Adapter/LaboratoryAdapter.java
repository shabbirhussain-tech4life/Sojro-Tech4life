...
public class LaboratoryAdapter extends RecyclerView.Adapter<LaboratoryAdapter.MyCasesViewHolder> implements Filterable {
    private final Context context;

    private List<JsonObject> items;
    private LaboratoryAdapter.ItemClickListner itemClickListner;
    private LaboratoryAdapter.VideoClickListener videoClickListener;
    private LaboratoryAdapter.ImageClickListner imageClickListener;
    private LaboratoryAdapter.SpinnerClickListner spinnerClickListener;
    ...
    public void setVideoClickListner(LaboratoryAdapter.VideoClickListener videoClickListner) {
        this.videoClickListener = videoClickListner;
    }

    public void setImageClickListner(LaboratoryAdapter.ImageClickListner imageClickListner) {
        this.imageClickListener = imageClickListner;
    }

    public void setSpinnerClickListner(LaboratoryAdapter.SpinnerClickListner spinnerClickListner) {
    ...
    public void swap(List<JsonObject> datas) {
        items.clear();
        items.addAll(datas);
        mFilter = new LaboratoryAdapter.CaseFilter(datas);
    ...
    @Override
    public LaboratoryAdapter.MyCasesViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_radiology_cases, parent, false);
        return new LaboratoryAdapter.MyCasesViewHolder(v);

    }

    @Override
    public void onBindViewHolder(LaboratoryAdapter.MyCasesViewHolder holder, int position) {
        ...
        try {
            ...
            holder.txtLocation.setText(item.get("diagnosisl").getAsString());
