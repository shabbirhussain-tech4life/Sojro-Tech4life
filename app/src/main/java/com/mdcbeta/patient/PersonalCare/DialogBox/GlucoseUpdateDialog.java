...
public class GlucoseUpdateDialog extends BaseDialogFragment {
    ...
    public static GlucoseUpdateDialog newInstance() {
        GlucoseUpdateDialog frag = new GlucoseUpdateDialog();
        return frag;
    }
