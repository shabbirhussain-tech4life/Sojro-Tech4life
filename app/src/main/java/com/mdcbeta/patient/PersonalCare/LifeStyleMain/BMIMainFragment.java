...
public class BMIMainFragment extends BaseFragment implements BaseDialogFragment.DialogClickListener {
...
public void careGiverClick() {
        getFragmentHandlingActivity().addDialog(this, BMIDialog.newInstance());
        }
