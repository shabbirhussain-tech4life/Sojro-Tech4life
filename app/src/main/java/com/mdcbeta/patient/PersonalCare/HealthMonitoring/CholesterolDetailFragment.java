...
public class CholesterolDetailFragment extends BaseFragment {
    ...
    public static CholesterolDetailFragment newInstance(String id) {
        CholesterolDetailFragment fragment = new CholesterolDetailFragment();
        mId = id;
        return fragment;
    }
        ...
        apiFactory.getCholesterolDetail(mId)
                ...
                .subscribe(resource -> {
                    ...
                    if(resource.status) {
                        ...
                        try {
                            txtActivity.setText(data.get("device").getAsString());
                        } catch (Exception ex) {
                            ex.printStackTrace();
                        }
                        ...
                        try {
                            txtDuration.setText(data.get("result").getAsString());
                        } catch (Exception ex) {
                            ex.printStackTrace();
                        }
