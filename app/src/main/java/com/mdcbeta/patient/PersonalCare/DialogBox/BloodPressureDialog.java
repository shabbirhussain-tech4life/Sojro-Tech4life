...
public class BloodPressureDialog extends BaseDialogFragment {
    ...
    public static BloodPressureDialog newInstance() {
        BloodPressureDialog frag = new BloodPressureDialog();
        return frag;
    }
