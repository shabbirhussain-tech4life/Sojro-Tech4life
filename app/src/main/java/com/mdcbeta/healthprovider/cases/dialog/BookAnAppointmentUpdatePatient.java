...
public class BookAnAppointmentUpdatePatient  extends BaseDialogFragment {
...
String convertchckg;
  ...
  public void onStart() {
    ...
    genderPosition = mArgs.getString("gender");

   // chckg = Integer.parseInt(convertchckg);
...
//    genderPosition = Integer.parseInt(convertchckg);
  }
    ...
    apiFactory.updatePatientProfile(patient_profile_update)
      ...
      .subscribe(objectResponse -> {
        ...
        //  showProgress("Loading");
          ...
          showProgress("Profile updated successfully !");
